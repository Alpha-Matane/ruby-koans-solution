...
class AboutIteration < Neo::Koan
  ...
  end # @nswer: inject goes through an array, does something with its inner variables and returns them after finishing.
  ...
  # @nswer: I think 'end' closes the file, which frees the memory and allows other programs to open it again.
end
