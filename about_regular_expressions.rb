...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # @nswer: 1. When it is a part of an operator which will not match anyway (for above strings it would be something like /zy*z/). 2. It can fail if it will search the asterix itself (like /\*/).
  end
  ...
  #
  # Why?
  # @nswer: These operators match everything as long as they can, so [/ab*/] can bring results like "a", "abb" or "abbbbbbb", be it good or bad.
  # ------------------------------------------------------------------
  ...
  #@nswer: one character class can describe only one character ([abc]) while alternations can choose between entire character sets (a|b|c|potato). 
  # ------------------------------------------------------------------
