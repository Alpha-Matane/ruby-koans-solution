...
class AboutClassMethods < Neo::Koan
  ...
  # @nswer: I prefer the later because it stands out more and seems to be shorter when a class has multiple methods. The former seems to be better for smaller classes though.
  # ------------------------------------------------------------------
